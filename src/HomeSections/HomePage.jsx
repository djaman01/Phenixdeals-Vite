  ...
  return (
    ...
    <main className="overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Phenix-deals est une plateforme Marocaine dédiée au dépôt et à la vente d'objets d'art: tableaux, décoration, bijoux. Contactez-nous pour plus d'informations"
        />
